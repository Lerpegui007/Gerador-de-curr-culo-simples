...
const perfil_profissional = formData.get('perfil profissional')
const habilidades = formData.get('habilidades')
const formacao = formData.get('formação')
const experiencia_profissional = formData.get('experiência profissional')
...
localStorage.setItem('formacaooFor',formacao)
